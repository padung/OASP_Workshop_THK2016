package io.oasp.application.restaurantmanagement.general.common.api.exception;

import io.oasp.application.restaurantmanagement.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link io.oasp.application.restaurantmanagement.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the restaurantmanagementEntity entity.
